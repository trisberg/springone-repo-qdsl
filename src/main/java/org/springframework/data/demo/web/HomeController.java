...
public class HomeController {
	...
	public String home(Model model) {
		...
		model.addAttribute("version", "The QueryDSL Repository Version for SpringOne 2GX 2011");
	...
	public String modifyBook(@ModelAttribute("book") Book book, BindingResult result, SessionStatus status, HttpServletRequest request) {
		
		if (request.getParameter("_cancel") != null) {
			return "redirect:/";
		}
		if (request.getParameter("_delete") != null) {
			bookShelf.remove(book.getIsbn());
			return "redirect:/";
		}
		if (result.hasErrors()) {
			return "editBook";
